module.exports = {
	...
	adminId: "856861743024308234", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTE3MzY2MjExOTIwNDUwNzc2OQ.GEM6s6.JboUWQtMeIzGRp2EbvQ8t_J9was6GaSJlaDbg4", //- Bot's Token
	clientId: process.env.clientId || "1173662119204507769", //- ID of the bot
	clientSecret: process.env.clientSecret || "6TUdrmqpwrpuBUSLsZPDuJdmkEbwIj0h", //- Client Secret of the bot
